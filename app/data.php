...
return [
    ...
    'services' => [
        ['name' => 'Individualni časovi — klasični pilates', 'desc' => 'Časovi prema individualnim potrebama klijenata, rad na svim pilates aparatusima.'],
        ['name' => 'Individualni časovi — savremeni pilates', 'desc' => 'Časovi prema individualnim potrebama klijenata, rad na reformeru.'],
        ['name' => 'Duo časovi — klasični pilates', 'desc' => 'Dve osobe približno sličnog nivoa, uz upotrebu svih pilates aparatusa.'],
        ['name' => 'Duo časovi — savremeni pilates', 'desc' => 'Dve osobe približno sličnog nivoa, uz upotrebu reformera.'],
        ['name' => 'Trio časovi — klasični pilates', 'desc' => 'Tri osobe približno sličnog nivoa, uz upotrebu svih pilates aparatusa.'],
        ['name' => 'Grupni časovi — savremeni pilates', 'desc' => 'Grupe do 5 vežbača, vežbanje na reformeru.'],
        ['name' => 'Kifoza fix — specijalizovan program', 'desc' => 'Grupa do 5 vežbača; čas fokusiran na jačanje leđa, otvaranje grudi i poboljšanje cele posture.'],
        ['name' => 'Pilates legs — specijalizovan program', 'desc' => 'Grupa do 5 vežbača; akcenat na jačanje donjeg dela tela i integraciju centra sa donjim delom tela.'],
        ['name' => 'Teens pilates — specijalizovan program', 'desc' => 'Grupa do 5 tinejdžera (13–19 godina); čas usmeren na poboljšanje posture i jačanje celokupnog tela.'],
        ['name' => 'Wall Unit — klasični pilates', 'desc' => 'Grupa do 4 vežbača; kombinacija Mat i Cadillac repertoara.'],
        ['name' => 'Vikend paket — savremeni pilates', 'desc' => 'Grupa do 5 vežbača; vežbanje ograničeno na vikend.'],
    ],

    'prices_individual' => [
        // [program, jedinica/opis, cena, opcioni "paket"]
        ['Individualni — klasični pilates', '1 čas', '7.000 RSD'],
        ['Individualni — klasični pilates', '8 časova', '57.000 RSD'],
        ['Individualni — savremeni pilates', '1 čas', '4.800 RSD'],
        ['Individualni — savremeni pilates', '8 časova', '31.000 RSD'],
        ['Duo — klasični pilates', '1 čas', '10.000 RSD'],
        ['Duo — klasični pilates', '8 časova', '79.000 RSD'],
        ['Duo — savremeni pilates', '1 čas', '7.000 RSD'],
        ['Duo — savremeni pilates', '8 časova', '43.000 RSD'],
    ],
    'prices_group' => [
        ['Grupni — savremeni pilates', '8 časova', '12.000 RSD'],
        ['Grupni — savremeni pilates', '10 časova', '14.000 RSD'],
        ['Grupni — savremeni pilates', '12 časova', '16.000 RSD'],
        ['Kifoza fix', '8 časova', '12.000 RSD'],
        ['Pilates legs', '8 časova', '12.000 RSD'],
        ['Teens pilates', '8 časova', '12.000 RSD'],
        ['Wall Unit — prvi grupni čas', '1 čas', '1.500 RSD'],
        ['Wall Unit — pojedinačni čas', '1 čas', '2.000 RSD'],
        ['Vikend paket — savremeni', '8 časova', '8.000 RSD'],
    ],
